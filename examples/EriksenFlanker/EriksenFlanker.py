...
on 2020-10-25 19:04:57. The code is partially based on the PsychoPy Builder compiler code and demos.
...
EriksenFlanker_cross_0.model_name = None
EriksenFlanker_cross_0.cname = 'EriksenFlanker_cross_0'

EriksenFlanker_image_1 = visual.ImageStim(win=win, name='EriksenFlanker_image_1', size=1.0, ori=0, pos=(0.0, 0.0))
EriksenFlanker_image_1.model_name = None
EriksenFlanker_image_1.cname = 'EriksenFlanker_image_1'

EriksenFlanker_keyboard_2 = keyboard.Keyboard()
EriksenFlanker_keyboard_2.model_name = None
EriksenFlanker_keyboard_2.cname = 'EriksenFlanker_keyboard_2'
...
EriksenFlanker_circle_3.model_name = None
EriksenFlanker_circle_3.cname = 'EriksenFlanker_circle_3'
...
EriksenFlanker_circle_4.model_name = None
EriksenFlanker_circle_4.cname = 'EriksenFlanker_circle_4'
