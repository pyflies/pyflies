...
on 2020-10-20 21:29:33. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Hello_text_0 = visual.TextStim(win=win, name='Hello_text_0', pos=(0.0, 0.0), height=0.2, color='#ffffff')
