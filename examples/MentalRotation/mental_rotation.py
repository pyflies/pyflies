...
on 2020-11-09 18:11:19. The code is partially based on the PsychoPy Builder compiler code and demos.
...
MentalRotation_circle = visual.Circle(win=win, name='MentalRotation_circle', size=0.01, radius=0.2, pos=(0.0, 0.0), lineColor='#ffffff', fillColor='#ffffff')
...
execute_test(MentalRotation_2, MentalRotation_components)
