...
on 2020-10-27 14:03:16. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Parity_cross = visual.ShapeStim(win=win, name='Parity_cross', vertices='cross', pos=(0.0, 0.0), size=0.2, lineColor='#ffffff', fillColor='#ffffff')
Parity_cross.model_name = None
Parity_cross.cname = 'Parity_cross'

Parity_text = visual.TextStim(win=win, name='Parity_text', pos=(0.0, 0.0), height=0.2, color='#ffffff')
Parity_text.model_name = None
Parity_text.cname = 'Parity_text'

Parity_keyboard = keyboard.Keyboard()
Parity_keyboard.model_name = None
Parity_keyboard.cname = 'Parity_keyboard'
Parity_keyboard.valid_keys = ['left', 'right', 'quit']

Parity_circle = visual.Circle(win=win, name='Parity_circle', radius=1.0, fillColor='red', lineColor='red', pos=(0.0, 0.0), size=0.2)
Parity_circle.model_name = None
Parity_circle.cname = 'Parity_circle'

Parity_circle_2 = visual.Circle(win=win, name='Parity_circle_2', radius=1.0, fillColor='green', lineColor='green', pos=(0.0, 0.0), size=0.2)
Parity_circle_2.model_name = None
Parity_circle_2.cname = 'Parity_circle_2'
...
Intro_1 = r'''Parity classification
    ---------------------
...
Real_3 = r'''Parity classification
    ---------------------
