...
on 2020-10-21 18:35:03. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Posner_mouse_4 = event.Mouse()
Posner_mouse_4.model_name = None
Posner_mouse_4.cname = 'Posner_mouse_4'
Posner_mouse_4.mouseClock = core.Clock()
Posner_mouse_4.targets = [Posner_target]
