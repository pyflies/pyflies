...
on 2020-10-25 19:04:58. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Simon_cross_0 = visual.ShapeStim(win=win, name='Simon_cross_0', vertices='cross', pos=(0.0, 0.0), size=0.2, lineColor='#ffffff', fillColor='#ffffff')
Simon_cross_0.model_name = None
Simon_cross_0.cname = 'Simon_cross_0'

Simon_rectangle_1 = visual.Rect(win=win, name='Simon_rectangle_1', size=(0.2, 0.2))
Simon_rectangle_1.model_name = None
Simon_rectangle_1.cname = 'Simon_rectangle_1'

Simon_keyboard_2 = keyboard.Keyboard()
Simon_keyboard_2.model_name = None
Simon_keyboard_2.cname = 'Simon_keyboard_2'
Simon_keyboard_2.valid_keys = ['left', 'right', 'quit']

Simon_circle_3 = visual.Circle(win=win, name='Simon_circle_3', radius=1.0, fillColor='red', lineColor='red', pos=(0.0, 0.0), size=0.2)
Simon_circle_3.model_name = None
Simon_circle_3.cname = 'Simon_circle_3'

Simon_circle_4 = visual.Circle(win=win, name='Simon_circle_4', radius=1.0, fillColor='green', lineColor='green', pos=(0.0, 0.0), size=0.2)
Simon_circle_4.model_name = None
Simon_circle_4.cname = 'Simon_circle_4'
