...
def load_generators():
    ...
    if not _generators:
        ...
        # particular platform. The name of the generator is define in
        ...
        for gen in dir_names:
            ...
            gen_module = imp.load_module('__init__', moduleFile,
...
def generate(generator_name, model, target_folder):
    ...
    if exists(target_folder):
        ...
        if target_folder_list == [] or exists(pyflies_gen):
            ...
            raise PyFliesException(
                "Target folder does not have a '.pyflies.generated' file and is not empty!" +
    ...
    # Run generator
    _generators[generator_name][1].generate(model, target_folder)
